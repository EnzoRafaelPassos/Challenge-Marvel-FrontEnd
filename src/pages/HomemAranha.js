...
import HomemAranhaCircle from '../imagens/HomemAranhaCircle.png'
                ...
                <div className="card-background-todo">
                    <div className="card-background">
                        <div className="img-left">
                            <img className="img-homemAranha" src={HomemAranhaCircle} />
                        </div>
                        <div className="texto-right">
                            <h1 className="titulo-cardHeroi">Spider Man</h1>
